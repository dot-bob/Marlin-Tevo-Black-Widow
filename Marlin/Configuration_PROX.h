 ...
 *
 */
#ifndef CONFIGURATION_PROX_H
#define CONFIGURATION_PROX_H
...
#define STRING_CONFIG_H_AUTHOR "(dot_bob, PROX)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "RC8 V3.2 PROX"
...
// Note the following offsets are for the TEVO Black Widow with stock extruder, and either LJ series Inductive/Capacitive
//  probes, or SN04-N Inductive probe, with mounting brackets here from LP: http://www.thingiverse.com/thing:1829292
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define ABL_GRID_POINTS_X 4 // black widow has a large bed so use 4 grid points
