 ...
 *
 */
#ifndef CONFIGURATION_BLT_H
#define CONFIGURATION_BLT_H
...
#define STRING_CONFIG_H_AUTHOR "(dot_bob, BLT)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "RC8 V3.2 BLT"
...
// Note the following offsets are for the bracket TEVO own metal Black Widow BLTouch probe located
// which are delivered in the BLT kits after March 2017
