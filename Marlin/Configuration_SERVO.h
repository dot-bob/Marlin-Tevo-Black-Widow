 ...
 *
 */
#ifndef CONFIGURATION_SERVO_H
#define CONFIGURATION_SERVO_H
...
#define STRING_CONFIG_H_AUTHOR "(dot_bob, SERVO)" // Who made the changes.
...
// Displayed in the LCD "Ready" message
  #define CUSTOM_MACHINE_NAME "RC8 V3.2 SERVO"
