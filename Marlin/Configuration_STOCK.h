 ...
 *
 */
#ifndef CONFIGURATION_STOCK_H
#define CONFIGURATION_STOCK_H
...
#define STRING_CONFIG_H_AUTHOR "(dot_bob, STOCK)" // Who made the changes.
...
// Displayed in the LCD "Ready" message
  #define CUSTOM_MACHINE_NAME "RC8 V3.2 STOCK"
